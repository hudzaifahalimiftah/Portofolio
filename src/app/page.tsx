    ...
    <main style={{ background: "transparent" }}>
      ...
      <section style={{
        ...
        <h1 className="fu fu-3 hero-h1" style={{
          ...
          color: "#F5F5F5", maxWidth: 900, marginBottom: 24,
          fontFamily: "var(--font-inter)",
        }}>
        ...
        <p className="fu fu-4" style={{
          color: "#666", fontSize: 18, maxWidth: 600,
        ...
        <div className="fu fu-5" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center", marginBottom: 24 }}>
        ...
        {/* Social links */}
        <div className="fu fu-5" style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
          {data.social.map((s) => (
            <a
              key={s.label}
              href={s.href}
            ...
            <div className="bento-card" style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                <div style={{
                  ...
                  <span style={{ color: "#000", fontWeight: 900, fontSize: 14, fontFamily: "var(--font-inter)" }}>
                    AL
                  </span>
                </div>
                <div>
